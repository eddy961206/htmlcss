...
public class Member {
	private String name, id, pw, mail_id, mail_tail;
	private String zipcode, address1, address2, f_tell, m_tell, l_tell;
	private String birth_year, birth_month, birth_day, calendar, gender;
	private String newletter, sms, m_number, v_number, job;
	private String marital_status, hobbys;
