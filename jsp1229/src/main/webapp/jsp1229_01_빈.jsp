...
<!-- jsp:useBean id=참조변수명 class=객체위치 scope=사용범위 / -->
<!-- Student student = new Student(); 과 같 -->
...
<html>
	...
	<body>
		<!-- name: 참조변수명, property:변수명, value:값 -->
		<jsp:setProperty name="student" property="stuNum" value="1"/>  <!--  student.stuNum = "1" -->
		...
		<p>학번 : <jsp:getProperty name="student" property="stuNum" /></p>  <!--  student.stuNum  -->
