...
<%
	...
	String[] hobbys = null;
	id = (String)session.getAttribute("sessionId"); //세션 사용해서 id 얻기
	MemberDao mdao = new MemberDao();
	MemberDto mdto = mdao.selectMemberOne(id); // 그 아이디로 누구인지 구별해서 한명의 데이터 가져오기
	...
	<body>
		...
		<table>
			<tr>
				<th>아이디</th>
				<td><%=mdto.getId() %>
					<input type="hidden" name="id" value="<%=mdto.getId() %>"> <!-- 히든으로 아이디 보내주기 -->
				</td>
			</tr>
			<tr>
				<th>패스워드</th>
