<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<% request.setCharacterEncoding("utf-8"); %> <!-- post방식으로 데이터 들어올때 한글처리임 -->
<!DOCTYPE html>
<html lang="ko">
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <section>
    ...
    <table>
      ...
      <tr>
        <td colspan="4" id="bpre">
        	<a href="#"><strong>이전글</strong> <span class="separator">|</span> [키즈잼] 2020년 1분기 정기 휴관일 안내</a>
        </td>
      </tr>
    </table>
