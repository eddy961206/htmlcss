<%@page import="com.java.ex.Member"%>
				...
				<fieldset class="fieldset_class">
					...
					<dl id="modify_interests_dl">
						...
						<dd>
							<ul>
								<li>
									<input type="checkbox" name="hobby" id="computer" value="computer" <%if(member.getHobbys().contains("computer")) out.println("checked"); %>/>
									<label for="computer">컴퓨터/인터넷</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="movie" value="movie" <%if(member.getHobbys().contains("movie")) out.println("checked"); %>/>
									<label for="movie">영화/비디오</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="music" value="music" <%if(member.getHobbys().contains("music")) out.println("checked"); %>/>
									<label for="music">음악</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="shopping" value="shopping" <%if(member.getHobbys().contains("shopping")) out.println("checked"); %>/>
									<label for="shopping">쇼핑</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="game" value="game" <%if(member.getHobbys().contains("game")) out.println("checked"); %>/>
									<label for="game">게임</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="culture" value="culture" <%if(member.getHobbys().contains("culture")) out.println("checked"); %>/>
									<label for="culture">문화/예술</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="parenting" value="parenting" <%if(member.getHobbys().contains("parenting")) out.println("checked"); %>/>
									<label for="parenting">육아/아동</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="cooking" value="cooking" <%if(member.getHobbys().contains("cooking")) out.println("checked"); %>/>
									<label for="cooking">요리</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="interier" value="interier" <%if(member.getHobbys().contains("interier")) out.println("checked"); %>/>
									<label for="interier">인테리어</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="leisure" value="leisure" <%if(member.getHobbys().contains("leisure")) out.println("checked"); %>/>
									<label for="leisure">레저/여가</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="health" value="health" <%if(member.getHobbys().contains("health")) out.println("checked"); %>/>
									<label for="health">건강/다이어트</label>
								</li>
								<li>
									<input type="checkbox" name="hobby" id="fashion" value="fashion"<%if(member.getHobbys().contains("fashion")) out.println("checked"); %>/>
